...
namespace coro_test
{
  ...
  public:
    ...
    public:
      ...
      dummy_co_has_member_co_await get_return_object() noexcept
      {
  ...
  private:
    ...
    dummy_co_has_member_co_await(std::coroutine_handle<promise_type> child_coro) noexcept :
      unique_child_coro_{ child_coro }
    {
    }

  public:
    dummy_co_has_member_co_await(const dummy_co_has_member_co_await&) = delete;
    dummy_co_has_member_co_await& operator=(const dummy_co_has_member_co_await&) = delete;
